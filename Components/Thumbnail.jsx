...
export default function Thumbnail({ result }) {
    ...
    return (
        <div className={"group p-2 cursor-pointer transition duration-200 ease-in transform sm:hover:scale-105 hover:z-10"} onClick={() => router.push(`/Details?movieId=${result.id}&genre=${result.type || result.media_type || "movie"}`)}>
            ...
            <div className={"p-2"}>
                ...
                <p className={"inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-green-600 rounded-full"}>{result.type || result.media_type || "movie"}</p>
